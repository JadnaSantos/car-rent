...
import { FinishCarController } from './finish-car-controller-car';
import { HttpRequest } from '../../../contracts/Http';
import { FinishCarUseCase } from '../../../../modules/useCases/car/finish-car/finish-car';

interface SutTypes {
  sut: FinishCarController
  finishCarSubUseCaseStub: jest.Mocked<FinishCarUseCase>
}
...
const makeSut = (): SutTypes => {
  const finishCarSubUseCaseStub: jest.Mocked<FinishCarUseCase> = {
